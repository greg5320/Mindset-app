      ...
      <div className="learning__container">
        ...
        <div className="learning__grid">
          ...
          <div className="learning-card learning-card--white">
            ...
            <p className="learning-card__text">
            Мы используем проверенные и актуальные методики преподавания. Наши уроки всегда динамичны и адаптированы под индивидуальные потребности каждого ученика. Занятия проводятся два раза в неделю, а система рейтинга повышает мотивацию ребенка и позволяет отслеживать его прогресс
            </p>
          </div>
